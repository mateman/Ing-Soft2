...
<?php require RUTA_APP.'/views/includes/userinterface-menu.php'; ?>
 ...
 <div class="container">
    ...
    <div class="form-group">
      ...
      <input class="form-control"type="datetime-local" name="fechayhorasalida" placeholder="   dd/mm/aaaa  hh:mm" id="fechayhorasalida" min="<?php echo date('d-m-Y\ H:i'); ?>" max="30-06-2019 16:30"  pattern="[0-9]{2}(-|/)[0-9]{2}(-|/)[0-9]{4} ([0-9]{1}|[0-9]{2}):[0-9]{2}" required /> 
    </div>
    ...
    <div class="form-group">
      ...
      <input class="form-control" type="datetime-local" name="fechayhorallegada" placeholder="   dd/mm/aaaa  hh:mm" id="fechayhorallegada" min="<?php echo date('d-m-Y\ H:i'); ?>" max="30-06-2019 16:30"  pattern="[0-9]{2}(-|/)[0-9]{2}(-|/)[0-9]{4} ([0-9]{1}|[0-9]{2}):[0-9]{2}" required>
    </div>
    ...
    <div class="form-group">
      ...
      <input class="form-control" type="number" name="costo" placeholder="   en $" id="costo">
    </div>
    ...
    <label for="tipodeviaje">Tipo de viaje:</label>
      <select id= 'tipodeviaje' name="tipodeviaje" onchange="cambiarRepetir()">
    ...
    <label for="autodelviaje">Tipo de auto:</label>
      <select id= 'autodelviaje' name="autodelviaje">
       ...
       <TR><TD><input type="number" name="repetir" placeholder="repetir" id="repetir" style="visibility:hidden"><br></TD></TR>
    </div>
